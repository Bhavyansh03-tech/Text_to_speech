...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Initializing Recognizer Launcher and getting data from recognizer :->
        ...
        Box(
            ...
            Column(
                ...
                IconButton(onClick = {
                    ...
                    intent.putExtra(RecognizerIntent.EXTRA_LANGUAGE, Locale.getDefault()) // Language Understandable.
                    intent.putExtra(RecognizerIntent.EXTRA_PROMPT, "Speak Now") // Text Inside Recognizer.
